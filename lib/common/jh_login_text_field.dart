...
//      _pwdImg = _pwdShow?ImageIcon(AssetImage('assets/images/ic_pwd_close.png')):ImageIcon(AssetImage('assets/images/ic_pwd_open.png')) ;
    ...
    var textColor = KColors.dynamicColor(
        context, KColors.kBlackTextColor, KColors.kBlackTextColor);
    var textStyle = TextStyle(fontSize: _textFontSize, color: textColor);
    var hintColor = KColors.dynamicColor(
        context, KColors.kFormHintColor, KColors.kFormHintColor);
    var hintTextStyle =
        TextStyle(fontSize: _hintTextFontSize, color: hintColor);
    var underlineColor = KColors.dynamicColor(
        context, Theme.of(context).primaryColor, KColors.kBlackTextColor);

    var themeColor = KColors.kThemeColor;
    var labelTextStyle =
    ...
    return Theme(
      ...
      data: ThemeData(
        ...
        primarySwatch: AppColors.materialColor(themeColor),
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: widget.border ??
                  const UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.grey, width: _lineHeight)),
              focusedBorder: widget.border ??
                  UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: underlineColor, width: _lineHeight)),
